...
The rule and its scope are stated in docs/development/gates.md under "The test
...
def main() -> int:
    ...
    if findings:
        ...
        print(
            ...
            '\n\nThe rule and its scope are in docs/development/gates.md, "The test shadowing gate".',
            file=sys.stderr,
        )
        return 1
