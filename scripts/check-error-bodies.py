...
The rule and its scope are stated in docs/development/gates.md under "The error body
...
def main() -> int:
    ...
    if new:
        ...
        print(
            '\nThe rule and its scope are in docs/development/gates.md, "The error body gate".',
            file=sys.stderr,
        )
        return 1
