...
The rule and its scope are stated in docs/development/gates.md under "The schema
...
def main() -> int:
    ...
    if new:
        ...
        print(
            '\nThe rule and its scope are in docs/development/gates.md, "The schema response gate".',
            file=sys.stderr,
        )
        return 1
