...
Signup completion awaits its explicit auth refresh and a fresh profile before
navigating, so the guard does not read an unfinished sign-up and send the
account back into it.
