...
discovery, and refuses four things: a module with a test that runs fewer or more
times across the shards than in the unlabelled suite, a test a shard would run
