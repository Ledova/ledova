...
OPERATOR_ONLY = {
    ...
    "tokens_registerexport": "Immutable records of who exported or copied a share class's register, written on the "
    "operator connection by the export route and the register outputs admin, and queried by staff in admin. No "
    "issuer or customer path reads them, and only the retention purge deletes them.",
