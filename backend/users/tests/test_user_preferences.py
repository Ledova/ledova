...
class UserPreferencesEndpointTest(APITestCase):
    ...
    def test_list_is_404_until_created_then_returns_client_keys(self):
        ...
        created = self.post(selectedPortfolio=str(self.portfolio.uuid))
    ...
    def test_a_foreign_portfolio_is_rejected_by_field_scoping(self):
        response = self.post(selectedPortfolio=str(self.foreign_portfolio.uuid))
